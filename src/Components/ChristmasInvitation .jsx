...
const ChristmasInvitation = () => {
  ...
  // Adding music playback
  useEffect(() => {
    const audio = new Audio("jingle-bells-christmas-holidays-celebration-background-intro-theme-265841.mp3"); // Update the path to the music file
    audio.loop = true; // Set the audio to loop indefinitely
    audio.volume = 0.5; // Set the volume to a reasonable level (optional)
    audio.play(); // Start playing the music when the component is mounted
  ...
  return (
    <div className="invitation-container">
      {/* Snowfall in the background */}
      <Snowfall snowflakeCount={1000} color="white" />
